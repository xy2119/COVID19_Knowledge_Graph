# COVID19 Semantic Knowledge Graph and Search Engine
## 🏆 Submission to The 2021 Imperial College Data Science Challenge


In the 2021 **[Data Science Institute](https://www.imperial.ac.uk/data-science/) Natural Language Processing Challenge**,  for text mining task , We aim to explore word representations and relational graphs that could serve as a medical and scientific knowledge repository.

<!-- ABOUT THE PROJECT -->
<h2 id="about-the-project"> :pencil: About The Project</h2>

## Dataset
[CORD-19](https://www.kaggle.com/datasets/allen-institute-for-ai/CORD-19-research-challenge) dataset from Kaggle.
